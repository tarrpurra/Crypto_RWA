...
import type { InvestmentScopeRequest, RecommendationResponse } from "./types";

function decisionQuery(walletAddress?: string, scope?: InvestmentScopeRequest | null): string {
...
export const decisionsApi = {
  getDecisions: (walletAddress?: string, scope?: InvestmentScopeRequest | null) =>
    request<RecommendationResponse>(`/decisions${decisionQuery(walletAddress, scope)}`),
};
